...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.editors'
        db.add_column('publications_publication', 'editors',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048),
                      keep_default=False)

        # Adding field 'Publication.language'
        db.add_column('publications_publication', 'language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publication.editors'
        db.delete_column('publications_publication', 'editors')

        # Deleting field 'Publication.language'
        db.delete_column('publications_publication', 'language')
    ...
    models = {
        ...
        'publications.publication': {
            ...
            'editors': ('django.db.models.fields.CharField', [], {'max_length': '2048'}),
